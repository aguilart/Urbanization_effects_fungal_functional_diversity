...
# Saprotrophs
png("Figures/heatmap_genus_freq_asex_sapro.png",
    width = 11.015 ,
    height = 17.03,
    units = "in", res = 300)
cowplot::plot_grid(
  spore_function_long %>% 
    ...
    #              mean, na.rm = T) %>% 
    ggplot() +
    aes(x = paste(Location, sites), y = reorder(genus, asexual_spore_volume_wt)) +
...
#Wood saprotrophs
png("Figures/heatmap_genus_freq_asex_wood_sapro.png",
    width = 11.015 ,
    height = 17.03,
    units = "in", res = 300)
cowplot::plot_grid(
...
png("Figures/heatmap_genus_freq_asex_endo.png",
    width = 11.015 ,
    height = 17.03,
    units = "in", res = 300)
cowplot::plot_grid(
...
## Lichen parasites
png("Figures/heatmap_genus_freq_asex_lichenP.png",
    width = 11.015 ,
    height = 17.03,
    units = "in", res = 300)
cowplot::plot_grid(
...
png("Figures/heatmap_genus_freq_asex_ecto.png",
    width = 11.015 ,
    height = 17.03,
    units = "in", res = 300)
cowplot::plot_grid(
...
### Plant pathogens
png("Figures/heatmap_genus_freq_asex_plant_path.png",
    width = 11.015 ,
    height = 17.03,
    units = "in", res = 300)
cowplot::plot_grid(
...
### Human pathogens
png("Figures/heatmap_genus_freq_asex_human_path.png",
    width = 11.015 ,
    height = 17.03,
    units = "in", res = 300)
cowplot::plot_grid(
