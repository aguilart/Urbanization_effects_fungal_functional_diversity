...
# Saprotrophs
png("Figures/heatmap_genus_abund_sapro.png",
    width = 11.015 ,
    height = 17.03,
    units = "in", res = 300)
cowplot::plot_grid(
...
#Wood saprotrophs
png("Figures/heatmap_genus_abund_wood_sapro.png",
    width = 11.015 ,
    height = 17.03,
    units = "in", res = 300)
cowplot::plot_grid(
...
png("Figures/heatmap_genus_abund_endo.png",
    width = 11.015 ,
    height = 17.03,
    units = "in", res = 300)
cowplot::plot_grid(
...
## Lichen parasites
png("Figures/heatmap_genus_abund_lichenP.png",
    width = 11.015 ,
    height = 17.03,
    units = "in", res = 300)
cowplot::plot_grid(
...
png("Figures/heatmap_genus_abund_ecto.png",
    width = 11.015 ,
    height = 17.03,
    units = "in", res = 300)
cowplot::plot_grid(
...
png("Figures/heatmap_genus_abund_human_path.png",
    width = 11.015 ,
    height = 17.03,
    units = "in", res = 300)
cowplot::plot_grid(
  spore_function_long %>% 
    ...
    facet_wrap(. ~ Ecosystem, scales = "free_x") +
    scale_fill_viridis_c(option = "turbo", direction = 1) +
    labs(title = "Human Pathogen abundance air") +
    ylab(label = "Relative abundance") +
    theme(axis.text.x = element_text(angle = 45, hjust = 1),
          axis.text.y = element_text(size = 5),
          axis.title = element_blank(),
  ...
  spore_function_long %>% 
    ...
    facet_wrap(. ~ Ecosystem, scales = "free_x") +
    scale_fill_viridis_c(option = "turbo", direction = 1) +
    labs(title = "Human pathogen abundance soil") +
    ylab(label = "Relative abundance") +
    theme(axis.text.x = element_text(angle = 45, hjust = 1),
          axis.text.y = element_text(size = 5),
          axis.title = element_blank(),
...
### Plant pathogens
png("Figures/heatmap_genus_abund_plant_path.png",
    width = 11.015 ,
    height = 17.03,
    units = "in", res = 300)
cowplot::plot_grid(
